...
<html lang="en">
   ...
   <body>
       ...
       <!-- =========================================================================================================================================================== -->
        <div class="container">
            <div class="down-lord d-flex col-xs-12 col-sm-11 col-lg-11 col-xl-11 col-md-12">
                            ...
                            <div class="present-map d-flex justify-content-between">
                                <ul class="nav d-flex" role="tablist">
                                    <li><a class="active" data-toggle="tab" href="#america-history" role="tab">
                                        <div class="america">
                                            <img src="../Images/religions/each-religion/christian/justin-main-UEesKwR8ccY-unsplash.jpg" alt="" width="100%" height="100%">
                                            <div class="name">In North & south <br>america</div>
                                        </div>
                                    </a></li>
                                    <li><a class="" data-toggle="tab" href="#africa-history" role="tab">
                                        <div class="africa">
                                            <img src="../Images/religions/each-religion/christian/annie-spratt-atOIKlVg-C8-unsplash.jpg" alt="" width="100%" height="100%">
                                            <div class="name">In africa</div>
                                        </div>
                                    </a></li>
                                    <li><a class="" data-toggle="tab" href="#europe-history" role="tab">
                                        <div class="Europe">
                                            <img src="../Images/religions/each-religion/christian/europeana-DyBM95141iM-unsplash.jpg" alt="" width="100%" height="100%">
                                            <div class="name">In Europe</div>
                                        </div>
                                    </a></li>
                                    <li><a class="" data-toggle="tab" href="#asia-history" role="tab">
                                        <div class="asia">
                                            <img src="../Images/religions/each-religion/christian/arturo-rey-CvnVk7GGQCg-unsplash.jpg" alt="" width="100%" height="100%">
