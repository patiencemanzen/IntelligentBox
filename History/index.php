                    ...
                    <div class="left-side-section ">
                        <div class="left-side-holder">
                            ...
                            <div class="top-background-image">
                                <img src="../Images/history-img/top_back.png" alt="" width="100%" height="100%">
                    ...
                    <div class="right-side-section">
                        <div class="right-side-section-holder">
                            ...
                            <div class="today-in-history">
                                <div class="t-in-history-title"> Days in History... </div>
                            ...
                            <div class="position-relative">
                                <div class="create-short-story">
                                    <div class="title-short-story"><i class="fa fa-share-alt"></i> Share your Story</div>
                                    <div class="user-typer d-flex">
                                        ...
                                        <div class="usr-textarea ml-2">
                                            <div class="type-something">
                                                <div name="" id="" onclick="openPostCreation()">Write something...</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="create-stoty-prive" id="create-stoty-prive">
                                    <div class="section-title">
                                        <div><i class="fa fa-share-alt"></i> Share your story</div>
                                    ...
                                    <form action="history_content.box.php" method="POST" enctype="multipart/form-data" id="news_form">
                                        <div class="create-area">
                                            <div class="image-story-preview mr-1" id='image-story-preview'>
                                        ...
                                        <div class="sectio-footer">
                                            ...
                                            <div class="send-post">
                                                <button type="submit" name="submit_news">Create Story</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="today-in-history mt-3">
                                <div class="t-in-history-title"> Custom shared story... </div>
