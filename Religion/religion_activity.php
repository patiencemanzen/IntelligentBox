   ...
   <head>
    ...
    <body class="bg-white">
        ...
        <div class="background-img">
            <!-- <img src="../Images/religions/religion-activity.png" alt="religion activity" width="100%" height="100%"> -->
                        ...
                        <div class="right-section">
                            <div class="right-holder">
                                ...
                                <div class="create-short-story mt-4 position-relative">
                                    <div class="title-short-story"><i class="fa fa-share-alt"></i> Share activities</div>
                                    <div class="user-typer d-flex">
                                        ...
                                        <div class="usr-textarea ml-2">
                                            <div class="type-something">
                                                <div id="" onclick="createPost(this)"><?php echo $firstName; ?>, What you're about?</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- give user privelege to create post through profile-->
                                    <div class="post-creation" id="post-creation">
                                        <div class="title-post-creation position-relative"><i class="fa fa-share-alt"></i> Share activities <span class="disable-post"><i class="fa fa-times" onclick="document.getElementById('post-creation').style.display = 'none'"></i></span></div>
       ...
       <script src="../Lib/now-ui-kit/now-ui-kit.js"></script>t>
