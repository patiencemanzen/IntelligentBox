        ...
        class Virtual_page extends Scyllar {
            ...
            public function getProfileDetail($url){
                ...
                $fetchBio = mysqli_fetch_assoc($executeBio);  ?>
                    ...
                    <div class="d-flex user-friend-images-flex">
                        <div class="friends-cover position-relative">
                            <!-- <div class="first-friends-image"><img src="../Images/religions/each-religion/islam/afdhal-n-r9H7hUhpy3Y-unsplash.jpg" alt="" width="100%" height="100%"></div> -->
                        </div>
                    </div>
            <?php }
                                        ...
                                        <div class="card-title-content">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item-card">
                                                    <a class="nav-link-box active" data-toggle="tab" href="#courses" role="tab">shared posts</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- end card title -->
