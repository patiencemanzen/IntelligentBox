                                        ...
                                        <div class="card-title-content">
                                            <ul class="nav" role="tablist">
                                                <li class="nav-item-box">
                                                    <a class="nav-link-box active" data-toggle="tab" href="#courses" role="tab"><i class="fa fa-graduation-cap"></i> My Class </a>
                                                </li>
                                                <li class="nav-item-box">
                                                    <a class="nav-link-box" data-toggle="tab" href="#trainer" role="tab"><i class="fas fa-chalkboard-teacher"></i> My trainer</a>
                                                </li>
                                            </ul>
                                        </div>
