<?php
    ...
    class Univarse extends Scyllar  implements Astronuts {
        ...
        public function registeAstro(){
            ...
            $selectidentityfollowing = "SELECT * FROM intelligent_users WHERE email='$this->followingEmail'";
            ...
            $selectfollower = "SELECT * FROM intelligent_users WHERE email='$this->followerEmail'";
            ...
            $saveFriends = "INSERT INTO user_follow_board VALUE ('','$getfolloweIdentity','$this->followerEmail','$getTitleFollower','$getIdentity','$this->followingEmail','$getTitle','$createdOn')";
    ...
    // IMPLEMENT CLASS 
    // ==============================================================================================================================================================================================
    $newUnivarse = new Univarse($followingClass,$followClass);
