                    ...
                    <div class="short-nav">
                        <div class="tabs-link">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#pQuestion" class="active" data-toggle="tab" role="tab">Published questions</a></li>
                                <li><a href="#Mquestion" class="" data-toggle="tab" role="tab">My questions</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="question-tab">
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="pQuestion">
                            <div class="recieved-question-rel">
                                <div class="related-questions">
                                    <div class="rel-que-content" id="rel_question_recieved">
                        ...
                        <div class="tab-pane" role="tabpanel" id="Mquestion">
                            <div class="question-content">
                                <div class="related-questions">
                                    <div class="rel-que-content" id="rel-question">
